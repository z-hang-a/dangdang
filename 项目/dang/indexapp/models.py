...
class DOrderiterm(models.Model):
    ...
    shop_bookid = models.DecimalField(max_digits=20, decimal_places=0)
    shop_ordid = models.DecimalField(max_digits=20, decimal_places=0)
...
class TAddress(models.Model):
    ...
    user_id = models.DecimalField(max_digits=20, decimal_places=0)
...
class TOrder(models.Model):
    ...
    order_addrid = models.DecimalField(max_digits=20, decimal_places=0)
    order_uid = models.DecimalField(max_digits=20, decimal_places=0)
